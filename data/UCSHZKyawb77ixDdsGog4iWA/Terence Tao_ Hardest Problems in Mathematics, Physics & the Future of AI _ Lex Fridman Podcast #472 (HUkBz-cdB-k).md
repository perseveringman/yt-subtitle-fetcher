...
thumbnail_url: "https://i.ytimg.com/vi/HUkBz-cdB-k/maxresdefault.jpg"
source_url_canonical: "https://www.youtube.com/watch?v=HUkBz-cdB-k"
channel: "Lex Fridman"
channel_name: "Lex Fridman"
channel_id: "UCSHZKyawb77ixDdsGog4iWA"
uploader_id: "@lexfridman"
published_at: "2025-06-14T20:15:34.000Z"
upload_date: "2025-06-14"
duration_seconds: 11674
duration_human: "3:14:34"
view_count: 1836453
like_count: 24994
has_subtitle: true
language: "en-US"
availability: "public"
fetched_at: "2026-05-12T03:16:02.978Z"
---
...
- language: en-US
- availability: public
- tags: Terence Tao, alex friedman, lex ai, lex debate, lex freedman, lex fridman, lex friedman, lex interview, lex lecture, lex mit, lex podcast, lex transcript
...
00:01:21 --> 00:01:25
xisting techniques can do like 90% of
...
00:01:44 --> 00:01:52
have um a needle um in on the plane.
...
00:01:58 --> 00:02:03
o do it in as little space as possible.
...
00:02:25 --> 00:02:30
a little bit more efficient than um
...
00:03:33 --> 00:03:38
he question is that if your telescope

00:03:35 --> 00:03:41
is not zero thickness but but just very

00:03:37 --> 00:03:43
thin some thickness delta what is
...
00:04:21 --> 00:04:25
particle and wave type behavior. So
...
00:04:49 --> 00:04:54
um that scenario and the equations
...
00:05:47 --> 00:05:53
hey would concentrate not just at a
...
00:06:12 --> 00:06:17
quations are stable or not whether they
...
00:06:33 --> 00:06:39
hat's called a singularity. We don't
...
00:07:34 --> 00:07:39
xistence and smoothness like you said
...
00:07:58 --> 00:08:02
million- dollar question yeah so
...
00:08:49 --> 00:08:53
omething called the compressible navio
...
00:08:56 --> 00:09:00
ynamics. A lot of it is actually just

00:08:57 --> 00:09:04
rying to solve the ny stokes equations
...
00:09:33 --> 00:09:38
's no reason why they should unmix
...
00:09:49 --> 00:09:54
ne side and then goes to the other and
...
00:10:03 --> 00:10:09
his can happen and we can't rule it
...
00:11:39 --> 00:11:46
nergy of fluid starts off at some um
...
00:11:55 --> 00:12:01
each time it does this uh it takes
...
00:12:24 --> 00:12:28
ransfer all the the energy from one big
...
00:12:42 --> 00:12:48
nergy keep it all together um and do it
...
00:13:30 --> 00:13:35
quations of motion of naval basically
...
00:13:46 --> 00:13:52
mall Eddie or this other small Eddie, I
...
00:13:55 --> 00:14:00
maller Eddie while still preserving the
...
00:14:07 --> 00:14:12
quation. How does that help you get
...
00:14:19 --> 00:14:24
quation, so which usually when you turn
...
00:15:47 --> 00:15:51
quations are like a tugof-war between
...
00:16:04 --> 00:16:08
energy from in one location of
...
00:16:19 --> 00:16:24
erm. If the dissipation term dominates,

00:16:22 --> 00:16:27
if it's if it's large, then basically

00:16:23 --> 00:16:29
ou get regularity. And if um if the
...
00:16:52 --> 00:16:57
this is why the problem is hard in
...
00:17:04 --> 00:17:08
ffect of transport and the effect of
...
00:17:50 --> 00:17:55
you can predict for millions of
...
00:17:55 --> 00:18:00
here's a reason why we can't predict

00:17:57 --> 00:18:02
he weather past 2 weeks into the future
...
00:18:41 --> 00:18:47
he aggregate behavior is important um

00:18:44 --> 00:18:49
but if you want to model a fluid um like

00:18:46 --> 00:18:51
the weather you can't just say in
...
00:19:26 --> 00:19:33
quation that that blew up. Um so one um
...
00:19:37 --> 00:19:42
get energy at one scale you you push
...
00:20:06 --> 00:20:12
nergy at one scale you're pushing it
...
00:20:12 --> 00:20:16
o the next scale but there's still some

00:20:13 --> 00:20:17
nergy left over from the previous

00:20:15 --> 00:20:19
cale. um you're trying to do everything

00:20:16 --> 00:20:22
at once. Um and this spreads out the

00:20:18 --> 00:20:24
nergy too much. Um and then it turns
...
00:20:29 --> 00:20:32
urns out this this direct bush doesn't

00:20:30 --> 00:20:33
actually work. There was a
...
00:20:59 --> 00:21:04
then you you push that in as well.

00:21:01 --> 00:21:06
So um by doing that it kind of the

00:21:03 --> 00:21:08
nergy inches forward scale by scale in
...
00:22:21 --> 00:22:27
quations of water support a computation
...
00:22:32 --> 00:22:38
they're powered by by electrons
...
00:23:54 --> 00:24:00
a it's a robot. Okay. And what it
...
00:27:12 --> 00:27:19
quation and and um the flu navis is a
...
00:27:44 --> 00:27:50
create um and gates and or gates for
...
00:28:06 --> 00:28:12
othing comes out. Mhm. So they could
...
00:30:30 --> 00:30:36
here's a very small number of things
...
00:30:51 --> 00:30:55
omething called low large numbers. It

00:30:52 --> 00:30:59
ells you you're going to get as many
...
00:32:09 --> 00:32:14
sometimes when you um add a plus b
...
00:32:15 --> 00:32:21
he sum plus minus one. Um so it's
...
00:32:26 --> 00:32:32
ffect that if if a function exhibits

00:32:27 --> 00:32:34
ome structure like this then um it's
...
00:32:34 --> 00:32:40
some other nearby function which
...
00:32:50 --> 00:32:55
ither have no structure at all or they

00:32:53 --> 00:32:57
are somehow related to something that is

00:32:54 --> 00:33:00
tructured. Um and in either way in
...
00:33:37 --> 00:33:43
ally really structured I can just take
...
00:34:13 --> 00:34:19
here's arithmetic progressions of
...
00:34:35 --> 00:34:40
ntire screw of Hamlet or any other

00:34:36 --> 00:34:41
finite string of text. Uh it will just

00:34:39 --> 00:34:42
ake some time quite a lot of time
...
00:35:32 --> 00:35:35
hat if I had as much money as I wanted
...
00:36:51 --> 00:36:56
eltas and and this there's a certain
...
00:37:03 --> 00:37:08
finite limits and what's called
...
00:37:23 --> 00:37:28
omething that you can you can um attack
...
00:37:33 --> 00:37:39
trying to generate. Um so um and
...
00:40:21 --> 00:40:25
here is this asteroid going to go? What
...
00:41:09 --> 00:41:15
hat tells experimenters where to look
...
00:41:17 --> 00:41:23
goes it goes back and forth. Um

00:41:21 --> 00:41:24
within mathematics itself there's

00:41:22 --> 00:41:26
also a theory and experimental
...
00:41:42 --> 00:41:48
nce we had computers um we be to do it
...
00:41:51 --> 00:41:55
number theory to call the prime
...
00:42:06 --> 00:42:12
se professional job it was to do
...
00:42:46 --> 00:42:50
urns out the number of different
...
00:43:32 --> 00:43:36
can you know they don't explore

00:43:34 --> 00:43:38
very single position in in the game
...
00:43:45 --> 00:43:48
visiting old chess theories about, oh,
...
00:44:14 --> 00:44:19
ormal explanation of the different
...
00:44:39 --> 00:44:45
hey're observing to be reality. Is that
...
00:46:21 --> 00:46:25
kind of thing. We have we have a
...
00:46:57 --> 00:47:02
dark matter model I think has like
...
00:48:07 --> 00:48:11
quations must be like infinitely
...
00:48:23 --> 00:48:26
here's a huge number of particles if
...
00:48:48 --> 00:48:58
hese 10 to 23 or whatever particles. Um
...
00:50:14 --> 00:50:19
uh you know 100,000 Americans with
...
00:50:24 --> 00:50:29
manage risk with options and

00:50:25 --> 00:50:31
erivatives and so forth and um and it

00:50:28 --> 00:50:33
here's a very beautiful theory um but

00:50:30 --> 00:50:36
if there are systemic shocks in the

00:50:32 --> 00:50:38
conomy uh that can push everybody to
...
00:51:13 --> 00:51:18
heorems it tells you that if you have
...
00:51:28 --> 00:51:33
imit theorem and someone proposes use
...
00:51:39 --> 00:51:45
orrelation between all your inputs and
...
00:51:49 --> 00:51:54
this synergy between science and

00:51:51 --> 00:51:57
mathematics. A little bit on the
...
00:52:08 --> 00:52:15
aid that you are the closest thing we
...
00:52:50 --> 00:52:56
cient example is um geometry and
...
00:53:06 --> 00:53:12
hey were not really considered related.
...
00:53:56 --> 00:54:00
nd geometry were separated and now we
...
00:54:16 --> 00:54:21
edgehogs and foxes. Um and then there's
...
00:54:46 --> 00:54:52
hink is related but I can I can adapt

00:54:48 --> 00:54:54
he tricks. So see the connections
...
00:55:18 --> 00:55:24
ncountering a new problem, you know,
...
00:56:28 --> 00:56:35
each particular uh technique. Um
...
00:56:43 --> 00:56:51
hat. Let's step back and uh

00:56:47 --> 00:56:53
maybe look at the the a bit of a
...
00:57:41 --> 00:57:46
here's infinitely many primes, okay,
...
00:58:21 --> 00:58:28
um you know it's not just getting a

00:58:24 --> 00:58:30
proof for a result was interesting but

00:58:27 --> 00:58:33
once you have that proof you know
...
00:58:57 --> 00:59:02
esults to actually be influential and
...
00:59:31 --> 00:59:37
n and has fewer bugs and whatever. Um

00:59:34 --> 00:59:41
and there's similar things with mathemat

00:59:36 --> 00:59:42
ics. So yeah the first of all
...
01:00:02 --> 01:00:08
Which I also find beautiful and
...
01:03:26 --> 01:03:31
is laws of of motion and then and then
...
01:03:47 --> 01:03:52
quations that there always seemed to be
...
01:04:46 --> 01:04:50
echanics, you know, because I think
...
01:05:11 --> 01:05:17
ather than than a function. But um and
...
01:05:17 --> 01:05:22
omething called Shingers equation that

01:05:19 --> 01:05:24
ells you exactly how quantum systems
...
01:05:31 --> 01:05:36
ou could start actually transferring a
...
01:06:14 --> 01:06:18
echanics. Even though the equations are
...
01:06:22 --> 01:06:28
quations will will have a conservation
...
01:06:35 --> 01:06:40
et we haven't figured out what the
...
01:06:47 --> 01:06:52
very tiny scales um there's going to

01:06:49 --> 01:06:54
be quite fluctuations of space

01:06:51 --> 01:06:56
-time foam um and trying to to use

01:06:53 --> 01:06:59
cartigian coord xyz is going to be it's

01:06:55 --> 01:07:01
just it's it's a non-starter but we
...
01:07:31 --> 01:07:36
avens with the motions on of objects
...
01:07:46 --> 01:07:52
of physics general relativity and
...
01:09:41 --> 01:09:49
eories are. But the other is like just
...
01:10:05 --> 01:10:11
cognition to intuitit what that
...
01:10:31 --> 01:10:38
by by round earth and round moon, you
...
01:11:10 --> 01:11:15
And it's a big leap and you have
...
01:12:40 --> 01:12:46
pherical cows whatever you know

01:12:42 --> 01:12:48
speculate. Um and you know this is this

01:12:45 --> 01:12:49
what mathematicians do and some what
...
01:13:53 --> 01:13:58
lectromagnetic field. Um there's
...
01:14:49 --> 01:14:54
nergy had to disperse a little bit and

01:14:51 --> 01:14:56
the moment it dis little bit it it would

01:14:53 --> 01:14:57
stay regular. Yeah. This was
...
01:15:55 --> 01:16:01
quation. I found this transformation
...
01:16:52 --> 01:16:57
ymbols maybe what are you visualizing
...
01:17:35 --> 01:17:40
his. So there's a dimension that's too
...
01:17:57 --> 01:18:01
there are 10 things that are making
...
01:18:38 --> 01:18:43
ro will get swarmed by a hundred bad
...
01:19:14 --> 01:19:18
verything I know about the problem on
...
01:19:54 --> 01:20:00
now I can do it in 10 15 minutes is
...
01:21:01 --> 01:21:08
he answer but but a proof that how it
...
01:21:40 --> 01:21:44
hey made the compiler really small and
...
01:21:46 --> 01:21:52
he the difference between writing on
...
01:22:19 --> 01:22:24
xplaining a proof to an extremely
...
01:22:39 --> 01:22:47
talk about X is X a real number or
...
01:23:02 --> 01:23:07
ften it it says wait a minute can you
...
01:23:47 --> 01:23:52
echnology. People are beginning to use
...
01:24:25 --> 01:24:29
here's now these large language models
...
01:24:55 --> 01:25:01
will work and then like half the time
...
01:25:26 --> 01:25:29
ffort time and effort taken to
...
01:25:35 --> 01:25:40
annoying. But doesn't it like kill
...
01:25:41 --> 01:25:47
oworker, right? Yeah. If if that was
...
01:26:07 --> 01:26:11
is number 12 and then a few weeks
...
01:26:30 --> 01:26:35
is constant 12 and then when this this

01:26:32 --> 01:26:38
new paper came out uh we said okay let's

01:26:34 --> 01:26:40
o that took like 3 weeks to formalize

01:26:37 --> 01:26:42
and and like 20 people to formalize this

01:26:39 --> 01:26:45
this original proof. I said oh but
...
01:27:18 --> 01:27:23
actics and so forth. Yeah, you can
...
01:28:11 --> 01:28:14
cattered all over the place and you
...
01:28:18 --> 01:28:22
ou could you open up a novel halfway
...
01:28:27 --> 01:28:31
it and it would it would say what
...
01:29:09 --> 01:29:13
doesn't quite work here is like the
...
01:29:34 --> 01:29:40
their um um in in the process, but
...
01:29:46 --> 01:29:52
ne, you're you're known for being a
...
01:30:48 --> 01:30:52
ort of jam sessions always at the
...
01:31:35 --> 01:31:42
ree. Um even and even um subsets of
...
01:31:43 --> 01:31:48
ree progressions. They didn't work for
...
01:32:06 --> 01:32:11
orem but I what I asked was a really
...
01:33:39 --> 01:33:46
mas um but often not all written with
...
01:34:40 --> 01:34:45
he split between theoretical and
...
01:35:29 --> 01:35:35
hese bespoke uh spaghetti code that
...
01:35:43 --> 01:35:50
xperimental results um but um yeah but
...
01:38:03 --> 01:38:08
re hoping to use a lot of AI as well.
...
01:38:16 --> 01:38:22
're formalizing it. In fact I was this
...
01:39:26 --> 01:39:30
definitely not want this to

01:39:28 --> 01:39:34
become like you know part of your tenure

01:39:29 --> 01:39:36
view or something. Uh um but um I mean
...
01:39:57 --> 01:40:02
It's true. It's true that Yeah. I
...
01:40:24 --> 01:40:29
I know. It's rational. So what

01:40:26 --> 01:40:32
we've done for this project is is

01:40:28 --> 01:40:34
elf-report. So um there are actually
...
01:41:37 --> 01:41:44
so. But we had decided at the time um

01:41:41 --> 01:41:47
not to try to decide who did what um but

01:41:44 --> 01:41:49
o have a single pseudonym. So we
...
01:41:57 --> 01:42:02
uthored under the pseudonym. So none of
...
01:42:33 --> 01:42:38
other 19 or whatever people that
...
01:42:43 --> 01:42:48
is matrix and we'll see how that
...
01:42:56 --> 01:43:01
aying that uh this might be the future
...
01:43:15 --> 01:43:22
he integration of AI into this whole
...
01:43:34 --> 01:43:39
evel mathematics problems. What do you
...
01:46:00 --> 01:46:06
tarted helped by by formalizing um but
...
01:46:35 --> 01:46:40
atural language rather than formal

01:46:37 --> 01:46:42
anguage. Oh I hope that happens. I hope
...
01:46:52 --> 01:46:59
number rather than a long form
...
01:47:04 --> 01:47:08
uh to reinforce do reinforcement
...
01:47:17 --> 01:47:23
hen you need a human to grade it to
...
01:49:10 --> 01:49:15
here's my results. Um and that type
...
01:50:18 --> 01:50:22
he reinforcement learning has actually
...
01:50:44 --> 01:50:48
omething called code smell, right? You
...
01:51:08 --> 01:51:13
one thing that humans have. Um and
...
01:53:08 --> 01:53:12
otally different ways of seeing this
...
01:53:49 --> 01:53:55
oftware tools that um can work at scale
...
01:54:37 --> 01:54:41
true for all n I've checked for n up
...
01:54:49 --> 01:54:54
I think ideas get proposed on both
...
01:56:01 --> 01:56:08
ese modern AI tools is and also just
...
01:56:22 --> 01:56:29
ense when you write a paper to to write
...
01:58:23 --> 01:58:27
here's how the proof of second case
...
01:59:22 --> 01:59:28
xactly. Um there are certainly math
...
01:59:53 --> 01:59:58
good example, you know. So, I I um

01:59:56 --> 02:00:01
it's annoying for me to code in
...
02:00:14 --> 02:00:19
view. Um I mean there's still a
...
02:00:21 --> 02:00:26
his I think is a civil war problem if
...
02:01:23 --> 02:01:28
buried in in a list of options for
...
02:01:39 --> 02:01:44
t of the silos of Yeah. Yeah. Yeah.
...
02:02:29 --> 02:02:36
his alpha zero moment with go that kind
...
02:04:38 --> 02:04:43
ou know go to grad courses, do the
...
02:05:00 --> 02:05:06
e problem and really cannot rest until
...
02:05:42 --> 02:05:48
opologies up priori that that a surface
...
02:06:25 --> 02:06:30
urns out that the this the sphere is
...
02:09:09 --> 02:09:14
urfaces um if you started simply
...
02:09:19 --> 02:09:23
the two dimensional result but by the
...
02:09:32 --> 02:09:38
lightly simpler but um Um yeah but but

02:09:36 --> 02:09:41
hey were considered hard nonlinear
...
02:11:30 --> 02:11:34
teps um and like like nothing that a
...
02:12:05 --> 02:12:10
hings what what can you infer from the
...
02:12:48 --> 02:12:52
howing up that that that for which your
...
02:13:03 --> 02:13:08
with your approach then maybe you
...
02:13:10 --> 02:13:15
till worth fighting um so yeah you have
...
02:13:56 --> 02:14:00
re planning celebrationally um to all
...
02:14:11 --> 02:14:16
show up in this expansion." And we

02:14:13 --> 02:14:17
stimate 12 of them, but in our notes, I
...
02:17:58 --> 02:18:04
ven if I activate all my all the cheats

02:18:00 --> 02:18:06
that I know of in this problem like it

02:18:03 --> 02:18:11
here's just still no way to get me to
...
02:18:29 --> 02:18:35
hese uh atoms the natural numbers have
...
02:18:48 --> 02:18:53
ou can take all the prime numbers 2 3
...
02:19:51 --> 02:19:57
he prime by two do you can you get a
...
02:21:02 --> 02:21:06
's not I mean initially there's
...
02:22:11 --> 02:22:16
ou know and you can take take any 99%
...
02:22:50 --> 02:22:56
ally genuinely random, if the primes
...
02:23:04 --> 02:23:09
andom almost. Well, we don't know.
...
02:23:17 --> 02:23:23
0% chance of error that the primes
...
02:23:50 --> 02:23:55
re are many proofs of of these sort
...
02:24:00 --> 02:24:06
he two together. Um but in twin primes
...
02:24:09 --> 02:24:15
a specific way that eliminates the

02:24:11 --> 02:24:17
twin the twins. Uh and we can't rule out

02:24:14 --> 02:24:20
hat one conspiracy and yet you were
...
02:24:28 --> 02:24:32
you believe the water is won by
...
02:24:36 --> 02:24:42
ncountered this kind of phenomen. Yeah.

02:24:38 --> 02:24:45
So like like um a pure like there's

02:24:41 --> 02:24:46
almost no way to um definitively
...
02:25:09 --> 02:25:13
So one unreasonable thing is is

02:25:11 --> 02:25:16
hard to dispute but but more than
...
02:26:02 --> 02:26:06
here's an infinite number of so it's
...
02:26:31 --> 02:26:35
ou have if you have 101 numbers 100 one
...
02:26:36 --> 02:26:42
f them have to belong to the same
...
02:26:49 --> 02:26:55
ut that fewer and fewer numbers are
...
02:27:00 --> 02:27:05
hey're not they they don't have no
...
02:27:31 --> 02:27:35
parse. They make um you can set up a
...
02:27:41 --> 02:27:46
those pairs of primes are just only
...
02:31:10 --> 02:31:15
some issue. Um, and you you ask one
...
02:31:41 --> 02:31:47
own but in some sense um as you keep
...
02:31:58 --> 02:32:03
ry few tools to show that something
...
02:35:00 --> 02:35:05
umbers get smaller, odd numbers get
...
02:35:11 --> 02:35:16
ogether. It's still reasonably simple.
...
02:35:35 --> 02:35:41
equence I just described um yeah 13 40
...
02:35:47 --> 02:35:52
o high school students as a first
...
02:35:56 --> 02:36:01
own because of the wind and sometimes
...
02:36:52 --> 02:36:57
roulette at at the casino with odds

02:36:55 --> 02:36:58
lightly weighted against you. So
...
02:37:21 --> 02:37:26
smaller than what you started. So,
...
02:37:51 --> 02:37:56
law of large numbers um which tells
...
02:39:19 --> 02:39:25
ncoded in a number that flies forever.
...
02:39:43 --> 02:39:49
own and he showed that once your
...
02:39:57 --> 02:40:03
inear transformations. He called a
...
02:40:44 --> 02:40:51
tatistically 99% you know go to one but
...
02:42:17 --> 02:42:22
here are there are actual patterns of
...
02:42:31 --> 02:42:39
he the primes? Yeah. That you're going
...
02:43:06 --> 02:43:11
vidence is sort of slightly pushing in
...
02:43:16 --> 02:43:22
vidence is le leaning pretty heavily on

02:43:18 --> 02:43:23
the no. Certainly more on the no than on

02:43:21 --> 02:43:25
the yes. The funny thing about
...
02:44:38 --> 02:44:43
ecognition is needed. Yeah. No, he's

02:44:40 --> 02:44:46
somewhat of an outlier. Um even
...
02:45:13 --> 02:45:17
to peace out uh and you know, collect
...
02:45:36 --> 02:45:42
other people who've done so as
...
02:46:00 --> 02:46:06
hen suddenly people want your opinion

02:46:03 --> 02:46:07
things and uh you have to think a
...
02:46:39 --> 02:46:46
great. This is it's always an option.
...
02:47:17 --> 02:47:22
hen as as you get more senior you have

02:47:20 --> 02:47:26
to start you know mentoring and and and

02:47:21 --> 02:47:27
giving interviews uh and uh and
...
02:47:40 --> 02:47:47
stablishment sort of the the really
...
02:49:55 --> 02:50:00
ucation I skipped a lot of classes um
...
02:51:22 --> 02:51:26
hat time. He's a professor there. It's
...
02:51:29 --> 02:51:35
heorem. What did you think maybe

02:51:31 --> 02:51:38
looking back now with more context about

02:51:34 --> 02:51:40
hat moment in math history? Yes. So I
...
02:52:09 --> 02:52:14
eah can can we take that small tangent
...
02:52:54 --> 02:52:59
hink he will be able to get all the way
...
02:54:18 --> 02:54:24
its with sort of the the romantic image
...
02:54:27 --> 02:54:34
izards or something. Um so that
...
02:54:43 --> 02:54:49
need people speak to it like what uh
...
02:55:06 --> 02:55:10
hey're convinced and they have the
...
02:55:30 --> 02:55:35
pic. Yeah, it works for me. Yeah, I
...
02:56:24 --> 02:56:28
volution has honed but we it doesn't we
...
02:57:34 --> 02:57:39
hings that I struggle with and vice
...
02:57:53 --> 02:57:59
each 30 different ways. On that topic
...
02:58:39 --> 02:58:44
ou know they for very specific reasons
...
02:58:54 --> 02:59:02
there's uh yeah um there's math
...
03:00:23 --> 03:00:29
specially modern mathematics seen as

03:00:25 --> 03:00:31
this extremely difficult to enter area

03:00:28 --> 03:00:32
nd programming is not. So that could be
...
03:03:18 --> 03:03:23
um new theorems. And um there are
...
03:03:26 --> 03:03:32
uh um we should run a workshop
...
03:04:12 --> 03:04:17
xcited about the subject. So I started
...
03:04:46 --> 03:04:51
ormalization and there's a limit to how
...
03:04:53 --> 03:04:57
hen I say that this is going to change
...
03:05:11 --> 03:05:16
in a project that I I I realized
...
03:05:40 --> 03:05:46
omething better than you. Yeah. Um I
...
03:05:58 --> 03:06:02
uh I mean because people will ask
...
03:06:39 --> 03:06:43
you plot cumulatively over time,
...
03:06:50 --> 03:06:56
e concept of of numbers you know you
...
03:07:33 --> 03:07:38
's one one thing that actually uh
...
03:07:47 --> 03:07:51
here's a certain technique that that

03:07:49 --> 03:07:53
can be applied they will try it but

03:07:50 --> 03:07:54
here are problems for which they see
...
03:08:59 --> 03:09:04
talk to athletes like marathon
...
03:09:10 --> 03:09:15
ricking yourself to to think that the
...
03:09:45 --> 03:09:50
for example if if I didn't even
...
03:10:04 --> 03:10:08
ally the the the formulation of the

03:10:06 --> 03:10:12
problem is incorrect because there

03:10:07 --> 03:10:16
ally is no longer a just a solo human.
...
03:10:17 --> 03:10:23
We're already like a collective
...
03:10:26 --> 03:10:32
ays than than the individual humans put

03:10:29 --> 03:10:35
ogether. It can also have less. Okay.

03:10:31 --> 03:10:38
But uh um yeah, so yeah, mathemat

03:10:34 --> 03:10:41
ical community plural is is is
...
03:11:28 --> 03:11:34
really creative and enthusiastic
...
03:11:46 --> 03:11:52
ou know can become like trivial to
...
03:12:32 --> 03:12:39
hat I mean? Yeah. and just the internet

03:12:35 --> 03:12:40
and and our AI. I mean again they

03:12:38 --> 03:12:42
've been in they're beginning to be
...
03:13:17 --> 03:13:21
beautiful that we humans are able to
